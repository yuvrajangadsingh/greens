...
4. Update `homebrew-contrib-mirror/Formula/contrib-mirror.rb` with new tag URL + sha256
...
- `sync.sh` — main script, CLI entry point, version string lives here
